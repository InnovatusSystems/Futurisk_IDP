...
namespace Futurisk
{
    public partial class NationalInsurance : Form
    {
        ...
        //    {
        //        var InsuredName = ((Microsoft.Office.Interop.Excel.Range)wks.Cells[i, 6]).Value.Replace("\n", "").TrimStart();
        //        //var InsuredType = ((Microsoft.Office.Interop.Excel.Range)wks.Cells[i, 9]).Value.Replace("\n", "").TrimStart();
        //        var PolicyNo = ((Microsoft.Office.Interop.Excel.Range)wks.Cells[i, 4]).Value.Replace("\n", "").TrimStart();
        ...
        //        var Premium_Amt = ((Microsoft.Office.Interop.Excel.Range)wks.Cells[i, 13]).Value;
        ...
        //        {
        //            Premium_Amt = Premium_Amt.Replace("\n", "").Replace(",", "").TrimStart();
        //        }
